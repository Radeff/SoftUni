public class OutputMessages
{
    ...
    public const string MissionsSuccessfulSummary = "Successful missions - {0}";

    public const string MissionsFailedSummary = "Failed missions - {0}";

    public const string InputEnd = "Enough! Pull back!";
